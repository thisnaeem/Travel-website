  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl p-8 max-w-md relative animate-fade-in">
        ...
        <h3 className="text-2xl text-black font-bold mb-4">Need a Custom Professional Website?</h3>
        <p className="text-gray-600 mb-6">
          Hi! I'm Naeem Anjum, a web developer specializing in creating beautiful, 
          high-converting websites & SaaS products. If you're impressed with this demo, 
